...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            if (url == null) {
                return jsonResponse;            // i.e. return an empty string
            }
            ...
            try {
                ...
                //Receiving the response and making sense out of it for our app
                ...
                Log.e(LOG_TAG, "Problem retrieving the earthquake JSON results.", e);    // No internet connection
            } finally {
        ...
        private String readFromStream(InputStream inputStream) throws IOException {
            ...
            if (inputStream != null) {
                // Reads data single character at a time
                InputStreamReader inputStreamReader = new InputStreamReader(inputStream, Charset.forName("UTF-8"));

                // BufferedReader reads and saves a larger chunk of data at a time
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            // if the jsonResponse string is empty or null then return early
            if(TextUtils.isEmpty(earthquakeJSON)) {         // .is empty is same as (str==null) || (str.length()==0)
                return null;
            }
